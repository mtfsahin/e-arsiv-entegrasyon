...
$UUID = $doc->createElementNS(
    $urn,
    "cbc:UUID",
    "abf8a880-aa37-40bb-8527-569cff5f659e"
);
$invoice->appendChild($UUID);

// IssueDate
$IssueDate = $doc->createElementNS($urn, "cbc:IssueDate", "2023-03-06");
...
$id = $doc->createElementNS(
    $urn,
    "cbc:ID",
    "18ac891e-92df-42d1-9193-5ad9b507f013"
);
...
$ID = $doc->createElementNS(
    $urn,
    "cbc:ID",
    "a1bc7e63-87e0-46b0-bc5b-5107e652dc5b"
);
...
$streetName = $doc->createElementNS(
    $urn,
    "cbc:StreetName",
    "A.T.G.B. Üniversiteler Mah. 1605. Cad."
);
...
$externalURI = $doc->createElementNS(
    $urn,
    "cbc:URI",
    "#Signature_abf8a880-aa37-40bb-8527-569cff5f659e"
);
...
$id = $doc->createElement("cbc:ID", "11111111111");
...
$cityName = $doc->createElement("cbc:CityName", "Ankara");
$postalAddress->appendChild($cityName);

$country = $doc->createElement("cac:Country");
$postalAddress->appendChild($country);

$countryName = $doc->createElement("cbc:Name", "Türkiye");
$country->appendChild($countryName);
...
$firstName = $doc->createElement("cbc:FirstName", "test");
$person->appendChild($firstName);

$familyName = $doc->createElement("cbc:FamilyName", "test");
...
$Name = $doc->createElementNS($urn, "cbc:Name", "test ürün");
$Item->appendChild($Name);

$Price = $doc->createElementNS($urna, "cac:Price");
$InvoiceLine->appendChild($Price);

$PriceAmount = $doc->createElementNS($urn, "cbc:PriceAmount", "1");
